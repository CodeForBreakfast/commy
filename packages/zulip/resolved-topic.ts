 ...
 * models resolution as an observable `ThreadRef.resolved` boolean with a clean
 * `name`, so this glyph never crosses the port boundary: read paths strip it
 * here and surface the flag, the setter re-applies it here.
 */
